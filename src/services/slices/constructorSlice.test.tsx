...
//функция удаления параметра id из объекта (т.к. он генерируется через uuidv4 и постоянно меняется)
function deleteId(obj: TConstructorIngredient) {
  return (({ id, ...params }) => params)(obj);
}

//функция удаления параметра id из массива возвращаемых слайсом ингредиентов
